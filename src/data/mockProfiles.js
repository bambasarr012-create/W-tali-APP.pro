// Profils authentiques de départ pour la diaspora sénégalaise
export const INITIAL_PROFILES = [
  ...
  },
  {
    ...
    etudes: "Doctorat en Médecine",
    ecole: "UCAD & Paris Descartes",
  ...
  },
  {
    ...
    telephone: "+1 514 876 5432",
    profession: "Architecte d'Intérieur",
    etudes: "Master Architecture & Design",
  ...
  },
  {
    ...
    profession: "Trader Financier & Consultant",
    etudes: "Master Finance & Quantitative Economics",
    ecole: "Columbia University",
  ...
  },
  {
    ...
    profession: "Juriste d'Affaires Internationales",
    etudes: "Master 2 Droit International",
    ecole: "Université Jean Moulin Lyon 3",
    visionMariage: "court_terme",
    visionMariageLabel: "Court terme (< 6 mois)",
    dahira: "Niassène",
  ...
  },
  {
    ...
    ville: "Paris",
    pays: "France",
    email: "ibrahima.sene@example.com",
    telephone: "+33 6 88 77 66 55",
    profession: "Fondateur Startup EdTech",
    etudes: "Ingénieur & MBA",
    ecole: "Polytech Paris & HEC",
    visionMariage: "court_terme",
    visionMariageLabel: "Court terme (< 6 mois)",
    dahira: "Yoff Layène",
  ...
  },
  {
    ...
    telephone: "+32 4 12 34 56 78",
    profession: "Responsable Marketing Digital",
    etudes: "Master Marketing & Communication",
    ecole: "Solvay Brussels School",
    visionMariage: "moyen_terme",
    visionMariageLabel: "Moyen terme (6-12 mois)",
    ...
    verified: true,
    createdAt: "2026-02-15T13:10:00Z"
  },
  {
    id: "user_ousmane_8",
    prenom: "Ousmane",
    ...
    profession: "Architecte & Promoteur Immobilier",
    etudes: "Diplôme d'État d'Architecte",
    ecole: "École d'Architecture de Dakar (EAMAU)",
    visionMariage: "court_terme",
    visionMariageLabel: "Court terme (< 6 mois)",
    dahira: "Touba Mouride",
...
export const POPULAR_INTERESTS = [
  ...
  "Histoire & Culture",
  "Thiant & Chants",
  "Volontariat & Entraide",
  "Art & Architecture",
  "Mode pudique",
  "Finance & Investissement"
];

export const DAHIRA_OPTIONS = [
  "Touba Mouride",
  "Tivaouane Tidiane",
  "Yoff Layène",
  "Niassène Kaolack",
  ...
  "Médina Gounass",
  "Autre Dahira",
  "Non affilié / Respectueux de toutes"
];

export const VISION_MARIAGE_OPTIONS = [
  { value: "court_terme", label: "Court terme (< 6 mois)", desc: "Prêt pour une union rapide dans les règles" },
